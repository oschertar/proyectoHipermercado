...
public class HipermercadoOrdenado extends JDialog {
	...
	public HipermercadoOrdenado() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				MostrarHipermercado.class.getResource("/img/mostrar.png")));
		setTitle("Mostrar hipermercado");
		...
		contentPanel.setLayout(null);
		{
			...
			lblBarras.setBounds(24, 53, 112, 14);
		...
		txtBarras.setBounds(166, 50, 86, 20);
		...
		lblNombreDelArtculo.setBounds(24, 28, 112, 14);
		...
		txtNombre.setBounds(166, 25, 86, 20);
				...
				btnMostrar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						if (General.hipermercado.get(0) != null) {
							//Collections.sort(General.hipermercado.get(indice+1).compareTo(General.hipermercado.get(indice)));
	...
	private void empieza() {
		...
		indice = 0;
		mostrarProducto(General.hipermercado.get(0));
		comprobarTamaño();
	}
	...
	private void comprobarTamaño() {
		if (General.hipermercado.get(indice + 1) == null)
